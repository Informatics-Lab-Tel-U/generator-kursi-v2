import { A as AstroError, N as NoImageMetadata, U as UnsupportedImageFormat, p as MissingSharp } from './entrypoint_BhDECgMf.mjs';
import { b as baseService, d as detector, r as resolveDefaultOutputFormat, p as parseQuality } from './generic_Dbf1CIUX.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_Ciax4O7C.mjs').then(n => n.i)).default;
  } catch {
